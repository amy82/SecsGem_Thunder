                    ...
                    while (taskWork.CurrentStep < taskWork.EndStep)
                    {
                        switch (taskWork.CurrentStep)
                        {
                            ...
                            case 250:
                                ...
                                Globalo.ObjectActiveTasks.bNRecv_S6F12_Process_State_Change = -1;
                                ...
                                break;
                            case 300:
                                if (Globalo.ObjectActiveTasks.bNRecv_S6F12_Process_State_Change == 0)    //SETUP
                                {
                                ...
                                break;
                            case 350:
                                if (Globalo.ObjectActiveTasks.bNRecv_S6F12_Process_State_Change == 0)    //READY
                                {
                                    szLog = $"[LOT] (Ready)Process State Change Send Acknowledge [STEP : {nRetStep}]";
                                    Globalo.LogPrint("LotProcess", szLog);

                                    Globalo.ObjectActiveTasks.bNRecv_S6F12_Process_State_Change = -1;
                                    Globalo.ObjectActiveTasks.bNRecv_S6F12_PP_Selected = -1;
                                    Globalo.ObjectActiveTasks.bNRecv_S7F25_Formatted_Process_Program = -1;       //<--미리 초기화
                                    Globalo.ObjectActiveTasks.bNRecv_S2F49_PP_UpLoad_Confirm = -1;
                                ...
                                break;
                            case 400:
                                if (Globalo.ObjectActiveTasks.bNRecv_S6F12_PP_Selected == 0)     //S6F12 대기
                                {
                                    Globalo.ObjectActiveTasks.bNRecv_S6F12_PP_Selected = -1;
                            ...
                            case 450:
                                ...
                                break;
                            case 500:
                                if (Globalo.ObjectActiveTasks.bNRecv_S7F25_Formatted_Process_Program == 0)       //Ubisam 에서 보내고 0으로 변경
                                {
                                ...
                                else if (Globalo.ObjectActiveTasks.bNRecv_S2F49_PP_UpLoad_Confirm == 1)  //LGIT_PP_UPLOAD_FAIL 확인필요 250112
                                {
                                ...
                                break;
                            case 550:
                                if (Globalo.ObjectActiveTasks.bNRecv_S2F49_PP_UpLoad_Confirm == 0)   //LGIT_PP_UPLOAD_CONFIRM
                                {
                                    ...
                                    Globalo.ObjectActiveTasks.bNRecv_S2F49_PP_UpLoad_Confirm = -1;
                                    Globalo.ObjectActiveTasks.bNRecv_S6F12_PP_UpLoad_Completed = -1;
                                    Globalo.ObjectActiveTasks.bNRecv_S2F49_LG_Lot_Start = -1;      //미리 초기화
                                ...
                                break;
                            case 600:
                                if (Globalo.ObjectActiveTasks.bNRecv_S6F12_PP_UpLoad_Completed == 0)
                                {
                                    Globalo.ObjectActiveTasks.bNRecv_S6F12_PP_UpLoad_Completed = -1;
                                    //Recv S6F12
                            ...
                            case 800:
                                ...
                                break;
                            case 850:
                                if (Globalo.ObjectActiveTasks.bNRecv_S6F12_Process_State_Change == 0)
                                {
                                    szLog = $"[LOT] (Executing) Process State Change Acknowledge [STEP : {nRetStep}]";
                                    Globalo.LogPrint("LotProcess", szLog);

                                    Globalo.ObjectActiveTasks.bNRecv_S6F12_Process_State_Change = -1;
                                    Globalo.ObjectActiveTasks.bNRecv_S6F12_Lot_Processing_Started = -1;
                                    Globalo.ObjectActiveTasks.bNRecv_S2F49_LG_Lot_Start = -1;
                            ...
                            case 900:
                                ...
                                if (Globalo.ObjectActiveTasks.bNRecv_S6F12_Lot_Processing_Started == 0)  //ack  0일대만 양품 배출해야된다.
                                {
                                    szLog = $"[LOT] Lot Processing Started Acknowledge,Ack: {Globalo.ObjectActiveTasks.bNRecv_S6F12_Lot_Processing_Started} [STEP : {nRetStep}]";
                                    Globalo.LogPrint("LotProcess", szLog);
                                ...
                                else if (Globalo.ObjectActiveTasks.bNRecv_S6F12_Lot_Processing_Started == 1)   //nack 1일 아닐수도있다.
                                {
                                    //ack를 체크해야되나?
