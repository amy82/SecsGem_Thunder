...
namespace SecGemApp.Ubisam
{
    ...
    {
        public static readonly string OFFLINE_CHANGED_REPORT_10102 = "10102";
        public static readonly string EQUIPMENT_OPERATION_MODE_CHANGED_REPORT_10301 = "10301";
        public static readonly string PROCESS_STATE_CHANGED_REPORT_10401 = "10401";
        public static readonly string IDLE_REASON_REPORT_10402 = "10402";
        public static readonly string PROCESS_PROGRAM_STATE_CHANGED_REPORT_10601 = "10601";

        public static readonly string OBJECT_ID_REPORT_10701 = "10701";

        public static readonly string PP_SELECTED_REPORT_10702 = "10702";
        public static readonly string PP_UPLOAD_COMPLETED_REPORT_10703 = "10703";
        public static readonly string LOT_PROCESSING_STARTED_REPORT_10704 = "10704";
        public static readonly string LOT_PROCESSING_COMPLETED_REPORT_10710 = "10710";
        public static readonly string LOT_APD_REPORT_10711 = "10711";

        public static readonly string ABORTED_REPORT_10712 = "10712";
        public static readonly string MATERIAL_ID_REPORT_10713 = "10713";
        public static readonly string MATERIAL_CHANGE_COMPLETED_REPORT_10714 = "10714";
        public static readonly string OP_RECOGNIZED_OP_CALL_REPORT_10801 = "10801";
        public static readonly string OP_RECOGNIZED_TERMINAL_REPORT_10901 = "10901";




        public static readonly string T3_TIMEOUT_REPORT_11001 = "11001";
        public static readonly string CT_TIMEOUT_REPORT_11002 = "11002";

    }



    public enum eCURRENT_CONTROL_STATE : int { eEquipmentOffline = 1, eAttemprtOnline, eHostOffline, eOnlineLocal, eOnlineRemote };

    public enum ePROCESS_STATE_INFO : uint { eINIT = 1, eIDLE, eSETUP, eREADY, eEXECUTING, ePAUSE };

    public enum eLOT_PROCESSING_STATE : uint { eScan = 1, eReady, eWait, eProcessing, eCompleted };

    public enum ePP_CHANGE_ORDER_TYPE : uint { eHost = 1, eOperator = 2 };
    public enum ePP_CHANGE_STATE : uint { eCreated = 1, eEdited, eDeleted, eUploadListChanged };

    public enum eHOST_COMMAND : uint
    {
    ...
    public class DefinedV
    {
        ...
        public const string MDLN = "EEprom Verify Equip";
        public const string SOFTREV = "Ver1.0.0.1";
    }
    #endregion
